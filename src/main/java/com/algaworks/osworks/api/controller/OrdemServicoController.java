...
public class OrdemServicoController {
	...
	public ResponseEntity<OrdemServicoModel> buscar(@PathVariable Long ordemServicoId){
		...
		if(ordemServico.isPresent()) {
			// Sem a utilização do ModelMapper:
	...
	//Método privado para mapear domain model para representation model
	//através do ModelMapper
	private OrdemServicoModel toModel(OrdemServico ordemServico) {
		return modelMapper.map(ordemServico, OrdemServicoModel.class);
	}
	
	//Método privado para conversão de lista de OrdemServico para lista de OrdemServicoModel
	...
	//Método privado para transformar OrdemServicoInput em OrdemServico
